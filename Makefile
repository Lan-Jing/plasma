CC = mpicc
CFLAGS = -Wall -O3 --std=c99 -D_XOPEN_SOURCE=500 -D_POSIX_C_SOURCE=200809L -I. -Icommon -Icommon/thirdparty
...
debug: FORCE
debug: CFLAGS += -g -DRAY_COMMON_DEBUG=1
debug: all
...
$(BUILD)/mpi_tests: test/mpi_tests.c src/utils.c $(BUILD)/libplasma_client.so common/common.c
	$(CC) $(CFLAGS) -o $@ test/mpi_tests.c src/utils.c common/common.c -L$(BUILD) -lplasma_client 
...
$(BUILD)/plasma_manager: src/plasma_manager.c src/ib.c src/utils.c src/plasma.h src/plasma_client.c src/fling.h src/fling.c common
	$(CC) $(CFLAGS) src/plasma_manager.c src/plasma_client.c src/ib.c src/utils.c src/fling.c common/build/libcommon.a common/thirdparty/hiredis/libhiredis.a -o $(BUILD)/plasma_manager

$(BUILD)/libplasma_client.so: src/plasma_client.c src/utils.c src/fling.h src/fling.c common
	$(CC) $(CFLAGS) src/plasma_client.c src/utils.c src/fling.c common/build/libcommon.a -fPIC -shared -o $@

$(BUILD)/libplasma_client.a: src/plasma_client.o src/fling.o
	ar rcs $@ $^

$(BUILD)/example: src/plasma_client.c src/plasma.h src/utils.c src/example.c src/fling.h src/fling.c common
	$(CC) $(CFLAGS) src/plasma_client.c src/example.c src/utils.c src/fling.c common/build/libcommon.a -o $(BUILD)/example
